...
/* Sufixos '01.jpg' .. 'NN.jpg' — atalho para as cores só com .jpg em
   sequência. Onde há um .gif no fim, ele entra à parte (ver CORES). */
const jpgs = (n) =>
  Array.from({ length: n }, (_, i) => String(i + 1).padStart(2, '0') + '.jpg');

/* Uma linha por cor. `fotos` = sufixos dos arquivos em
   public/fotos/produtos/ dessa cor, na ordem em que aparecem (lista vazia
   → placeholder). */
const CORES = [
  { slug: 'tabby-shoulder-preto',           cor: 'Preto',            hex: '#1A1714', material: 'Couro liso',                     estoque: 5, fotos: [...jpgs(1), '02.gif'] }, // pasta "black black"
  { slug: 'tabby-shoulder-preto-dourado',   cor: 'Preto e Dourado',  hex: '#1A1714', material: 'Couro liso, ferragem dourada',   estoque: 5, fotos: [...jpgs(9), '10.gif'] }, // pasta "Black Gold"
  { slug: 'tabby-shoulder-preto-fosco',     cor: 'Preto Fosco',      hex: '#17140F', material: 'Couro liso de toque fosco',     estoque: 4, fotos: jpgs(8) }, // pasta "Black Par"
  { slug: 'tabby-shoulder-preto-metal',     cor: 'Preto Metalizado', hex: '#2A2622', material: 'Couro liso com brilho metálico', estoque: 4, fotos: jpgs(10) }, // pasta "Blk+meta"
  { slug: 'tabby-shoulder-marrom',          cor: 'Marrom',           hex: '#5B4033', material: 'Couro liso',                     estoque: 6, fotos: [...jpgs(8), '09.gif'] }, // pasta "Brow"
  { slug: 'tabby-shoulder-marrom-escuro',   cor: 'Marrom Escuro',    hex: '#3D2B20', material: 'Couro liso',                     estoque: 5, fotos: jpgs(2) }, // pasta "Brow parse"
  { slug: 'tabby-shoulder-jacquard-azul',   cor: 'Jacquard Azul',    hex: '#33415C', material: 'Jacquard com detalhes em couro', estoque: 4, fotos: jpgs(1) }, // pasta "Jacquard Blue" (1 foto disponível)
  { slug: 'tabby-shoulder-jacquard-marrom', cor: 'Jacquard Marrom',  hex: '#6B5138', material: 'Jacquard com detalhes em couro', estoque: 4, fotos: jpgs(1) }, // pasta "Jacquard brow" (1 foto disponível)
  { slug: 'tabby-shoulder-vinho',           cor: 'Vinho',            hex: '#5E2130', material: 'Couro liso',                     estoque: 5, fotos: jpgs(1) }, // pasta "Red Wine" (1 foto disponível)
  { slug: 'tabby-shoulder-branco',          cor: 'Branco',           hex: '#EDE7DD', material: 'Couro liso',                     estoque: 5, fotos: jpgs(1) }, // pasta "White" (1 foto disponível)
  { slug: 'tabby-shoulder-branco-off',      cor: 'Branco Off',       hex: '#E8E0D2', material: 'Couro liso',                     estoque: 3, fotos: jpgs(1) }, // pasta "White +" (1 foto disponível)
  { slug: 'tabby-shoulder-branco-gelo',     cor: 'Branco Gelo',      hex: '#F0ECE3', material: 'Couro liso',                     estoque: 3, fotos: jpgs(1) }, // pasta "White parse" (1 foto disponível)
];
