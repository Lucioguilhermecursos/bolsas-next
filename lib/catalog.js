...
const CORES = [
  ...
  { slug: 'tabby-shoulder-preto-metal',     cor: 'Preto Metalizado', hex: '#2A2622', material: 'Couro liso com brilho metálico', estoque: 4, fotos: jpgs(14) },
  { slug: 'tabby-shoulder-marrom',          cor: 'Marrom',           hex: '#5B4033', material: 'Couro liso',                     estoque: 6, fotos: [...jpgs(8), '09.gif', ...nums(10, 14)] },
  { slug: 'tabby-shoulder-marrom-escuro',   cor: 'Marrom Escuro',    hex: '#3D2B20', material: 'Couro liso',                     estoque: 5, fotos: jpgs(11) },
  ...
  { slug: 'tabby-shoulder-jacquard-marrom', cor: 'Jacquard Marrom',  hex: '#6B5138', material: 'Jacquard com detalhes em couro', estoque: 4, fotos: jpgs(6) },
  ...
  { slug: 'tabby-shoulder-branco-off',      cor: 'Branco Off',       hex: '#E8E0D2', material: 'Couro liso',                     estoque: 3, fotos: jpgs(11) },
  { slug: 'tabby-shoulder-branco-gelo',     cor: 'Branco Gelo',      hex: '#F0ECE3', material: 'Couro liso',                     estoque: 3, fotos: jpgs(9) },
];
