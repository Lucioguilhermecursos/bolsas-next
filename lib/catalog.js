...
/* Uma linha por cor. `fotos` = sufixos dos arquivos em
   public/fotos/produtos/ dessa cor, na ordem em que aparecem.

   TODAS as cores estão SEM FOTO (`fotos: []`): o site desenha um placeholder
   marcado na proporção certa — nunca a foto de outra peça. Para publicar as
   fotos de uma cor, salve os arquivos em public/fotos/produtos/ com o padrão
   <slug>-01.jpg, <slug>-02.jpg… e troque o `[]` da linha por `jpgs(N)`. */
const CORES = [
  { slug: 'tabby-shoulder-preto',           cor: 'Preto',            hex: '#1A1714', material: 'Couro liso',                     estoque: 5, fotos: [] },
  { slug: 'tabby-shoulder-preto-dourado',   cor: 'Preto e Dourado',  hex: '#1A1714', material: 'Couro liso, ferragem dourada',   estoque: 5, fotos: [] },
  { slug: 'tabby-shoulder-preto-fosco',     cor: 'Preto Fosco',      hex: '#17140F', material: 'Couro liso de toque fosco',     estoque: 4, fotos: [] },
  { slug: 'tabby-shoulder-preto-metal',     cor: 'Preto Metalizado', hex: '#2A2622', material: 'Couro liso com brilho metálico', estoque: 4, fotos: [] },
  { slug: 'tabby-shoulder-marrom',          cor: 'Marrom',           hex: '#5B4033', material: 'Couro liso',                     estoque: 6, fotos: [] },
  { slug: 'tabby-shoulder-marrom-escuro',   cor: 'Marrom Escuro',    hex: '#3D2B20', material: 'Couro liso',                     estoque: 5, fotos: [] },
  { slug: 'tabby-shoulder-jacquard-azul',   cor: 'Jacquard Azul',    hex: '#33415C', material: 'Jacquard com detalhes em couro', estoque: 4, fotos: [] },
  { slug: 'tabby-shoulder-jacquard-marrom', cor: 'Jacquard Marrom',  hex: '#6B5138', material: 'Jacquard com detalhes em couro', estoque: 4, fotos: [] },
  { slug: 'tabby-shoulder-vinho',           cor: 'Vinho',            hex: '#5E2130', material: 'Couro liso',                     estoque: 5, fotos: [] },
  { slug: 'tabby-shoulder-branco',          cor: 'Branco',           hex: '#EDE7DD', material: 'Couro liso',                     estoque: 5, fotos: [] },
  { slug: 'tabby-shoulder-branco-off',      cor: 'Branco Off',       hex: '#E8E0D2', material: 'Couro liso',                     estoque: 3, fotos: [] },
  { slug: 'tabby-shoulder-branco-gelo',     cor: 'Branco Gelo',      hex: '#F0ECE3', material: 'Couro liso',                     estoque: 3, fotos: [] },
];
