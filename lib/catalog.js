/* =========================================================================
   ...
   ---- Regra firme de nomenclatura ------------------------------------------

   Produtos usam nome próprio da acbolsa, descrevendo material e formato.
   Não usar nome, modelo ou monograma de outra casa de moda (Hermès, Louis
   Vuitton, Coach, Valentino, Bottega...). Além do risco jurídico, é o que
   sustenta a posição da marca: o argumento é o couro, não a etiqueta.
