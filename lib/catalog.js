/* =========================================================================
   ...
   Na tabela CORES, cada linha tem:
     ...
     fotos    caminhos das fotos (ver "Fotos" abaixo)
   ...
   Enquanto `fotos` estiver vazio, o site desenha um placeholder marcado na
   proporção certa — nunca a foto de outra peça no lugar.
   ...
   2. Liste os caminhos no campo `fotos` daquela linha de CORES:
        fotos: ['/fotos/produtos/tabby-shoulder-vinho-01.webp',
                '/fotos/produtos/tabby-shoulder-vinho-02.webp'],

   A 1ª foto é a da vitrine (cartão e imagem principal da página); as demais
   viram miniaturas na galeria. Formato .webp ou .jpg, proporção 4:5, o site
   recorta para o centro. Tamanho bom: 1200 × 1500 px. A lista completa por
   cor está em FOTOS.md, na raiz do projeto.
...
/* Uma linha por cor. O `slug` é o endereço da peça e o prefixo do arquivo
   de foto; não mude depois de publicado. */
const CORES = [
  { slug: 'tabby-shoulder-preto',           cor: 'Preto',                hex: '#1A1714', material: 'Couro liso',                     estoque: 5, fotos: [] }, // pasta "black black"
  { slug: 'tabby-shoulder-preto-dourado',   cor: 'Preto e Dourado',      hex: '#1A1714', material: 'Couro liso, ferragem dourada',   estoque: 5, fotos: [] }, // pasta "Black Gold"
  { slug: 'tabby-shoulder-preto-fosco',     cor: 'Preto Fosco',          hex: '#17140F', material: 'Couro liso de toque fosco',       estoque: 4, fotos: [] }, // pasta "Black Par"
  { slug: 'tabby-shoulder-preto-metal',     cor: 'Preto Metalizado',     hex: '#2A2622', material: 'Couro liso com brilho metálico',   estoque: 4, fotos: [] }, // pasta "Blk+meta"
  { slug: 'tabby-shoulder-marrom',          cor: 'Marrom',               hex: '#5B4033', material: 'Couro liso',                     estoque: 6, fotos: [] }, // pasta "Brow"
  { slug: 'tabby-shoulder-marrom-escuro',   cor: 'Marrom Escuro',        hex: '#3D2B20', material: 'Couro liso',                     estoque: 5, fotos: [] }, // pasta "Brow parse"
  { slug: 'tabby-shoulder-jacquard-azul',   cor: 'Jacquard Azul',        hex: '#33415C', material: 'Jacquard com detalhes em couro', estoque: 4, fotos: [] }, // pasta "Jacquard Blue"
  { slug: 'tabby-shoulder-jacquard-marrom', cor: 'Jacquard Marrom',      hex: '#6B5138', material: 'Jacquard com detalhes em couro', estoque: 4, fotos: [] }, // pasta "Jacquard brow"
  { slug: 'tabby-shoulder-vinho',           cor: 'Vinho',                hex: '#5E2130', material: 'Couro liso',                     estoque: 5, fotos: [] }, // pasta "Red Wine"
  { slug: 'tabby-shoulder-branco',          cor: 'Branco',               hex: '#EDE7DD', material: 'Couro liso',                     estoque: 5, fotos: [] }, // pasta "White"
  { slug: 'tabby-shoulder-branco-off',      cor: 'Branco Off',           hex: '#E8E0D2', material: 'Couro liso',                     estoque: 3, fotos: [] }, // pasta "White +"
  { slug: 'tabby-shoulder-branco-gelo',     cor: 'Branco Gelo',          hex: '#F0ECE3', material: 'Couro liso',                     estoque: 3, fotos: [] }, // pasta "White parse"
];
