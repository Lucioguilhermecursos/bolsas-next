...
const CORES = [
  ...
  { slug: 'tabby-shoulder-preto-dourado',   cor: 'Preto e Dourado',  hex: '#1A1714', material: 'Couro liso, ferragem dourada',   estoque: 5, nFotos: 9 }, // pasta "Black Gold"
  { slug: 'tabby-shoulder-preto-fosco',     cor: 'Preto Fosco',      hex: '#17140F', material: 'Couro liso de toque fosco',     estoque: 4, nFotos: 8 }, // pasta "Black Par"
  { slug: 'tabby-shoulder-preto-metal',     cor: 'Preto Metalizado', hex: '#2A2622', material: 'Couro liso com brilho metálico', estoque: 4, nFotos: 10 }, // pasta "Blk+meta"
  { slug: 'tabby-shoulder-marrom',          cor: 'Marrom',           hex: '#5B4033', material: 'Couro liso',                     estoque: 6, nFotos: 8 }, // pasta "Brow"
  { slug: 'tabby-shoulder-marrom-escuro',   cor: 'Marrom Escuro',    hex: '#3D2B20', material: 'Couro liso',                     estoque: 5, nFotos: 2 }, // pasta "Brow parse"
  { slug: 'tabby-shoulder-jacquard-azul',   cor: 'Jacquard Azul',    hex: '#33415C', material: 'Jacquard com detalhes em couro', estoque: 4, nFotos: 1 }, // pasta "Jacquard Blue" (1 foto disponível)
  { slug: 'tabby-shoulder-jacquard-marrom', cor: 'Jacquard Marrom',  hex: '#6B5138', material: 'Jacquard com detalhes em couro', estoque: 4, nFotos: 1 }, // pasta "Jacquard brow" (1 foto disponível)
  { slug: 'tabby-shoulder-vinho',           cor: 'Vinho',            hex: '#5E2130', material: 'Couro liso',                     estoque: 5, nFotos: 1 }, // pasta "Red Wine" (1 foto disponível)
  { slug: 'tabby-shoulder-branco',          cor: 'Branco',           hex: '#EDE7DD', material: 'Couro liso',                     estoque: 5, nFotos: 1 }, // pasta "White" (1 foto disponível)
  { slug: 'tabby-shoulder-branco-off',      cor: 'Branco Off',       hex: '#E8E0D2', material: 'Couro liso',                     estoque: 3, nFotos: 1 }, // pasta "White +" (1 foto disponível)
  { slug: 'tabby-shoulder-branco-gelo',     cor: 'Branco Gelo',      hex: '#F0ECE3', material: 'Couro liso',                     estoque: 3, nFotos: 1 }, // pasta "White parse" (1 foto disponível)
];
